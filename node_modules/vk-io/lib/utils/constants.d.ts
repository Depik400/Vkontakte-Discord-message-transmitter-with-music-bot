...
export declare type AttachmentTypeString = 'album' | 'audio' | 'audio_message' | 'graffiti' | 'doc' | 'market_album' | 'market' | 'photo' | 'story' | 'video' | 'wall' | 'poll' | 'gift' | 'link' | 'sticker' | 'wall_reply';
/**
