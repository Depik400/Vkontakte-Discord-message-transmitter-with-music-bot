...
export declare type DocsGetUploadServer = Objects.BaseUploadServer;
...
export declare type GroupsAddLinkResponse = Objects.GroupsGroupLink;
...
export declare type GroupsGetByIdLegacyResponse = Objects.GroupsGroupFull[];
...
export declare type MessagesSendUserIdsResponse = any[];
...
export declare type SecureGiveEventStickerResponse = any[];
