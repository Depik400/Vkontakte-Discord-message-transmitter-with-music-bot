...
import { StoryAttachment, PhotoAttachment, AudioAttachment, VideoAttachment, DocumentAttachment, GraffitiAttachment, AudioMessageAttachment } from '../structures/attachments';
export declare class Upload {
     ...
     */
    conduct({ field, params, getServer, serverParams, saveFiles, saveParams, maxFiles, attachmentType }: IUploadConduct): Promise<any>;
    /**
     * Building form data
     */
     ...
     * Upload form data
     */
    upload(url: URL | string, { formData, timeout }: {
        formData: FormData;
        timeout: number;
    }): Promise<any>;
}
