...
export declare type WallAttachmentOptions = AttachmentFactoryOptions<IWallAttachmentPayload>;
declare class WallAttachment extends Attachment<IWallAttachmentPayload, AttachmentType.WALL | 'wall'> {
     ...
     */
    get likes(): object | undefined;
    /**
     * Returns the post source
     */
    get postSource(): object | undefined;
    /**
     * Returns the geo location
     */
    get geo(): object | undefined;
    /**
