...
export declare type FriendActivityContextType = 'friend_activity';
export declare type FriendActivityContextSubType = 'friend_online' | 'friend_offline' | 'friend_invisible';
...
export declare type FriendActivityContextOptions<S> = ContextFactoryOptions<[number, number, number, number, number], S>;
