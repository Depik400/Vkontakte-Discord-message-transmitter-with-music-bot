...
export declare type DonutSubscriptionPriceContextType = 'donut_subscription_price';
export declare type DonutSubscriptionPriceContextSubType = 'donut_subscription_price_changed';
...
export declare type DonutSubscriptionPriceContextOptions<S> = ContextFactoryOptions<IDonutSubscriptionPriceContextPayload, S>;
