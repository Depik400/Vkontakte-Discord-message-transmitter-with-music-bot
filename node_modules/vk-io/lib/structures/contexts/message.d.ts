...
export declare type MessageContextType = 'message';
export declare type MessageContextPayloadEventType = 'chat_photo_update' | 'chat_photo_remove' | 'chat_create' | 'chat_title_update' | 'chat_invite_user' | 'chat_kick_user' | 'chat_pin_message' | 'chat_unpin_message' | 'chat_invite_user_by_link';
export declare type MessageContextSubType = 'message_new' | 'message_edit' | 'message_reply' | MessageContextPayloadEventType;
...
export declare type MessageContextOptions<S> = ContextFactoryOptions<IMessageContextPayload, S>;
declare class MessageContext<S = ContextDefaultState> extends Context<IMessageContextPayload, S, MessageContextType, MessageContextSubType> {
     ...
     */
    get replyMessage(): MessageContext | undefined;
    /**
     ...
     */
    send(text: string | IMessageContextSendOptions, params?: IMessageContextSendOptions): Promise<MessageContext>;
    /**
     * Responds to the current message
     */
    reply(text: string | IMessageContextSendOptions, params?: IMessageContextSendOptions): Promise<MessageContext>;
    /**
     * Sends a photos to the current dialog
     */
    sendPhotos(rawSources: AllowArray<IUploadSourceMedia>, params?: IMessageContextSendOptions): Promise<MessageContext>;
    /**
     * Sends a documents to the current dialog
     */
    sendDocuments(rawSources: AllowArray<IUploadSourceMedia>, params?: IMessageContextSendOptions): Promise<MessageContext>;
    /**
     * Sends a audio message to the current dialog
     */
    sendAudioMessage(source: IUploadSourceMedia, params?: IMessageContextSendOptions): Promise<MessageContext>;
    /**
     ...
     * Deletes the message
     */
    deleteMessage(options?: Params.MessagesDeleteParams): Promise<boolean>;
    /**
