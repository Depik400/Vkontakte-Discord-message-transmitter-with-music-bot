...
export declare type DonutSubscriptionContextType = 'donut_subscription';
export declare type DonutSubscriptionContextSubType = 'donut_subscription_create' | 'donut_subscription_prolonged' | 'donut_subscription_expired' | 'donut_subscription_cancelled';
export interface IDonutSubscriptionContextPayload {
    user_id: number;
    amount?: number;
    amount_without_fee?: number;
}
export declare type DonutSubscriptionContextOptions<S> = ContextFactoryOptions<IDonutSubscriptionContextPayload, S>;
