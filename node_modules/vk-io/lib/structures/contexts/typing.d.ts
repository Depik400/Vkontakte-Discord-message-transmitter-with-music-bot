...
export declare type TypingContextType = 'typing';
export declare type TypingContextSubType = 'typing_user' | 'typing_group' | 'message_typing_state';
export declare type TypingContextOptions<S> = ContextFactoryOptions<ITypingContextPayload, S>;
