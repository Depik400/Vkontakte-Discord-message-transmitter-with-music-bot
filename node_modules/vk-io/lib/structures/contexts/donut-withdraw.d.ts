...
export declare type DonutWithdrawContextType = 'donut_withdraw';
export declare type DonutWithdrawContextSubType = 'donut_money_withdraw' | 'donut_money_withdraw_error';
export interface IDonutWithdrawContextPayload {
    reason?: string;
    amount?: number;
    amount_without_fee?: number;
}
export declare type DonutWithdrawContextOptions<S> = ContextFactoryOptions<IDonutWithdrawContextPayload, S>;
