...
const debug$4 = createDebug__default['default']('vk-io:api');
...
class APIRequest {
    ...
    async make() {
        ...
        try {
            const response = await fetch__default['default'](`${options.apiBaseUrl}/${this.method}`, {
                method: 'POST',
                compress: false,
                agent: options.agent,
...
class Upload {
    ...
    async video(params) {
        ...
        if (params.link !== undefined) {
            const response = await fetch__default['default'](save.upload_url, {
    ...
    async buildPayload({ field, values, maxFiles, attachmentType }) {
        ...
        const tasks = values.map(async (media, i) => {
            ...
            if (typeof value === 'string') {
                if (isURL.test(value)) {
                    const response = await fetch__default['default'](value);
                    value = response.body;
    ...
    async upload(url, { formData, timeout }) {
        ...
        const encoder = new formDataEncoder.Encoder(formData);
...
const debug$3 = createDebug__default['default']('api-io:collect');
...
const debug$2 = createDebug__default['default']('vk-io:updates');
/**
 * Version polling
 */
...
class PollingTransport {
    ...
    async fetchUpdates() {
        ...
        let result;
        try {
            const response = await fetch__default['default'](this.url, {
                agent: this.options.agent,
                method: 'GET',
                compress: false,
                signal: controller.signal,
...
const debug$1 = createDebug__default['default']('vk-io:updates');
...
const debug = createDebug__default['default']('vk-io:updates');
// eslint-disable-next-line @typescript-eslint/no-explicit-any
